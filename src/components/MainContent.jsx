...
export default function MainContent() {
  ...
  const avilableCities = [
    ...
    {
      displayName: "العاشر من رمضان",
      apiName: "10th of ramadan",
    },
    {
      displayName: " بلبيس ",
      apiName: "Bilbais",
  ...
  const getTimings = async () => {
    ...
    const response = await axios.get(
      `https://api.aladhan.com/v1/timingsByCity?country=EGP&city=${selectedCity.apiName}`
    );
  ...
  return (
    <>
      ...
      <Divider
        style={{ marginTop: "20px", borderColor: "white", opacity: "0.3" }}
      />
